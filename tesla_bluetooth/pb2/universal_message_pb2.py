...
SessionInfoRequest = _reflection.GeneratedProtocolMessageType(
    "SessionInfoRequest",
    (_message.Message,),
    {
        "DESCRIPTOR": _SESSIONINFOREQUEST,
        "__module__": "universal_message_pb2",
...
RoutableMessage = _reflection.GeneratedProtocolMessageType(
    "RoutableMessage",
    (_message.Message,),
    {
        "DESCRIPTOR": _ROUTABLEMESSAGE,
        "__module__": "universal_message_pb2",
